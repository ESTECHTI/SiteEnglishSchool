...
(function($) {
	$.fn.extend({
		...
		} else if (options.weekStart == 'Seg') {
			$('#' + uniqueId).append('<div class="monthly-day-title-wrap"><div>Seg</div><div>Ter</div><div>Qua</div><div>Qui</div><div>Sex</div><div>Sáb</div><div>Dom</div></div><div class="monthly-day-wrap"></div>');
		} else {
		...
		function setMonthly(m, y){
			...
			if(options.weekStart == 'Dom' && firstDay != 7) {
				for(var i = 0; i < firstDay; i++) {
					$('#' + uniqueId + ' .monthly-day-wrap').prepend('<div class="monthly-day-blank"><div class="monthly-day-number"></div></div>');
				}
			} else if (options.weekStart == 'Seg' && firstDay == 0) {
				for(var i = 0; i < 6; i++) {
					$('#' + uniqueId + ' .monthly-day-wrap').prepend('<div class="monthly-day-blank" ><div class="monthly-day-number"></div></div>');
				}
			} else if (options.weekStart == 'Seg' && firstDay != 1) {
