...
<header>
    ...
    <a href="https://www.facebook.com/escolashowidiomas" target="_blank"><img id="face1" src="_imagens/face.jpg" alt="Facebook"></a>

    <a href="https://plus.google.com/u/0/+EscolaShowIdiomasGravata%C3%AD/posts" target="_blank"><img id="googleplus1" src="_imagens/googleplus.jpg" alt="Google Plus"></a>

    <a  href="https://twitter.com/Show_Idiomas" target="_blank"><img id="twitter1" src="_imagens/twitter.jpg" alt="Twitter"></a>

    <a  href="https://www.youtube.com/user/ShowIdiomas" target="_blank"><img id="youtube1" src="_imagens/youtube.jpg" alt="YouTube"></a>
...
<img id="usukflag" src="_imagens/us-uk-english.jpg" alt="Us Uk Flag">

<article>

    <p id="sobreingles">O curso de Inglês da Show Idiomas atende todas as faixas etárias e públicos: CRIANÇAS, ADOLESCENTES, ADULTOS e IDOSOS. Somos focados em resultados e desenvolvemos todas as habilidades necessárias ao aprendizado com qualidade: AUDIÇÃO, ESCRITA, FALA e LEITURA. Preparamos o aluno para o mercado de trabalho, viagem ou negócios.</p>
</article>

        <form action="ingles_process.php" method="post" id="fale">
            ...
            <fieldset id="pedido"><legend>Interesse em:</legend>
                    <p><input type="checkbox" name="tIng" id="cIng" checked/>
                        <label for="cIng">Fazer um curso de Inglês</label></p>
...
<img id="mapashowingles" src="_imagens/mapa.jpg">
