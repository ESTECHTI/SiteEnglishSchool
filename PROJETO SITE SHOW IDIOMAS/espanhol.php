...
<h4 id="espanhol">Espanhol</h4>


<img id="spainflag" src="_imagens/spainflag.jpg" width="35%">

<p id="sobreespanhol">O curso de Espanhol foi criado especialmente para você que quer abordar situações do dia a dia, nas quais os alunos possam se comunicar e atuar nos países do Mercosul e Europa. Somos focados em resultados e desenvolvemos todas as habilidades necessárias ao aprendizado com qualidade: AUDIÇÃO, ESCRITA, FALA e LEITURA. </p>


        <form action="espanhol_process.php" method="post" id="fale">
            ...
            <fieldset id="pedido"><legend>Interesse em </legend>
                <p><input type="checkbox" name="tEsp" id="cEsp" checked/>
                    <label for="cEsp">Fazer um curso de Espanhol</label></p>
...
<img id="mapashowespanhol" src="_imagens/mapa.jpg">
