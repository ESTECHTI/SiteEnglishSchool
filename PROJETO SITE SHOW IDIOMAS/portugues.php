...
<img id="brazilflag" src="_imagens/brazilflag.jpg" width="35%">

<p id="sobreportugues">Curso para quem quer fazer concurso público; reforço escolar; gramática; alfabetização; caligrafia; redação (foco em produzir textos coesos e claros); interpretação de textos e português para vestibular.</p>



        <form method="post" id="faleportugues" action="portugues_process">
            ...
            <fieldset id="pedido"><legend>Interesse em </legend>
                <p><input type="checkbox" name="tPort" id="cPort" checked/>
                    <label for="cPort">Fazer um curso de Português</label></p>
