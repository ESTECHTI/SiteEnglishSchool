...
<h4 id="frances">Francês</h4>


<img id="frenchflag" src="_imagens/frenchflag.jpg" width="35%">

<p id="sobrefrances">O curso de Francês da Show Idiomas é a oportunidade de aprender a se comunicar com mais de 200 milhões de pessoas ao redor do mundo. Este curso é destinado a jovens e adultos desde Básico até o Avançado.</p>





<form method="post" id="falefrances" action="frances_process.php">
            ...
            <fieldset id="pedido"><legend>Interesse em </legend>
                <p><input type="checkbox" name="tFran" id="cFran" checked/>
                    <label for="cFran">Fazer um curso de Francês</label></p>
